...
def claude_model_report() -> ModelReport:
    ...
    effort_ok = "max" in help_text and "--effort" in help_text
    status = "confirmed" if effort_ok else "needs_manual_check"
    evidence = "`claude --help` exposes --effort max" if effort_ok else "`claude --help` did not confirm max effort"
